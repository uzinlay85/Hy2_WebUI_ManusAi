        ...
        <div style="overflow-x: auto;">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <span class="code" id="url_{{ loop.index }}">hy2://{{ user['password'] | urlencode_pass }}@{{ domain }}:10443/?insecure=0&sni={{ domain }}&obfs=salamander&obfs-password={{ obfs_pass }}&ports=20000-50000&mport=20000-50000#{{ user['name'] | urlencode }}</span>
